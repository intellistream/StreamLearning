...
class RetrievalTrainer(Trainer):
    def __init__(self, *args, corpus: Dataset, model_args, file_logger, **kwargs):
        ...
        self.dataloader_start_index = None
        self.dataloader_end_index = None
    ...
    def get_train_dataloader(self) -> DataLoader:
        ...
        # index = list(range(self.start_idx, self.end_idx))
        # train_dataset = self.train_dataset.select(index)
    ...
    @torch.no_grad()
    def evaluate(self, eval_dataset: Dataset | None = None, ignore_keys: List[str] | None = None,
        ...
        result_path = RetrievalMetric._get_save_path(self.model_args.eval_data, args.output_dir, field="result",
...
class StreamDataCallBack(TrainerCallback):
